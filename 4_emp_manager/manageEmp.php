...
<?php
    ...
    // Check if there is a POST request to add a new employee
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $pdo->prepare("INSERT INTO employee (FirstName, LastName, NickName, Tel, Username, Password, Position) 

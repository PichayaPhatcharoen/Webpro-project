...
<body>
        ...
        <div class="flex justify-center items-center gap-48 mt-8">
            ...
            <a href="summarySales.html" class="icon2 flex items-center justify-center w-96 h-96"><img src="../1_home/elements/chart.png" alt="" style="width: 180px; height: 180px;"></a>
        </div>

        <div class="txt flex justify-center items-center mt-8" style="gap: 420px;">

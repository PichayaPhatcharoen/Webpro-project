...
<header>
    <div class="header">
        <div class="header flex justify-between ">
            <div class="header-left flex items-center gap-0 md:garounded-full h-10 w-10 p-30">
                <a href="" class="logo rounded-full object-cover flex items-center justify-center overflow-hidden" alt="logo"></a>
                <a href="#default" class="webname">Fern n Friends café</a>
            </div>
            <div class="header-right flex items-center gap-0 md:garounded-full h-10 w-10 p-30">
